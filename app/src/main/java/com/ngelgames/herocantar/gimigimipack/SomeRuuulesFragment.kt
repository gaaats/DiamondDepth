...
import com.ngelgames.herocantar.databinding.FragmentSomeRuuulesBinding

class SomeRuuulesFragment : Fragment() {
    private var _binding: FragmentSomeRuuulesBinding? = null
    private val binding get() = _binding ?: throw RuntimeException("FragmentSomeRuuulesBinding = null")

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        _binding = FragmentSomeRuuulesBinding.inflate(inflater, container, false)
        return binding.root
    }
