...
import com.ngelgames.herocantar.databinding.ActivityVeebVieeeevBinding
...
class VeebVieeeevActivity : AppCompatActivity() {
    ...
    lateinit var bind: ActivityVeebVieeeevBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityVeebVieeeevBinding.inflate(layoutInflater)
        setContentView(bind.root)

        vv = bind.veebVieeeeev
        Snackbar.make(
            bind.root, "Loading...",
        ...
        vv.webChromeClient = object : WebChromeClient() {
            override fun onShowFileChooser(
                ...
                chooserIntent.putExtra(Intent.EXTRA_TITLE, getString(R.string.dfgtimage_chooser))
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val pack = "com.ngelgames.herocantar"

        val myId: String? = Hawk.get(GoodGoodClass.MYID, "null")
        val instanceId: String? = Hawk.get(GoodGoodClass.INSTID, "null")
        ...
        val first = "http://"
        val second = "diamonddepth.xyz/go.php?to=2&"
